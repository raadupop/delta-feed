...
| 5 | 2026-04-09 | MACROECONOMIC | INITIAL_CLAIMS (weekly) | `macro_initial_claims_weekly_surprise_2026_04_09.json` | SOURCED, PENDING /trader | **Per-indicator-frequency axis exerciser** (ADR-0001). 219K actual vs 210K consensus (investing.com). Seed: 5 weekly surprises Feb-Mar 2026. 21-day gap since last_update exercises the 7-day vs 30-day frequency bug via `temporal_relevance_max` assertion. xfail(strict=True) until Phase B. |
| 6 | 2019-09-16 | MARKET_DATA | OVX | `market_data_ovx_aramco_attack_2019_09_16.json` | SOURCED, PENDING /trader | **Non-VIX symbol axis.** Saudi Aramco drone attack — OVX 35→49 (z=+11.2). Seed: FRED OVXCLS last 20 closes to 2019-09-13. Exercises shared `_TANH_SCALE=20.0` on crude oil vol (structurally higher baseline than VIX). |
...
| 9 | 2019-07-15 | MARKET_DATA | VIX | `market_data_vix_normal_day_2019_07_15.json` | SOURCED, PENDING /trader | **Known false positive — noise-zone axis.** Calm summer day, VIX 12.68 vs window median 14.54. SRS ECDF rank = 0.90 (top decile by rank within quiet window) vs trader truth ~0. Band: `score_max: 0.20`. Test FAILS today by design — stays red until a noise-zone gate lands in SRS CLS-001. Same pathology as anchor #11. |
...
| 11 | 2017-10-05 | MARKET_DATA | VIX | `market_data_vix_low_vol_regime_2017_10_05.json` | SOURCED, PENDING /trader | **Known false positive — noise-zone axis.** VIX 9.19 in 2017's pre-Volmageddon low-vol regime; window median ~10.16, ECDF rank = 0.90 (SRS formula) vs trader truth ~0. Band: `score_max: 0.20`. Test FAILS today by design — stays red until a noise-zone gate (absolute-magnitude / vol-of-vol / window-spread) lands in SRS CLS-001. Data: FRED VIXCLS, retrieved 2026-04-27. |
